...
topics.forEach(t => {
  ...
  const maxDept = Object.entries(deptScore)
  .sort((a,b) => b[1] - a[1])[0][0];

let decision = "İzleme önerilir";

if (maxDept === "donanim")
  decision = "Donanım iyileştirme öncelikli olarak önerilir";
else if (maxDept === "musteri")
  decision = "Müşteri hizmetleri süreçleri iyileştirilmeli";
else if (maxDept === "kargo")
  decision = "Kargo firması / teslimat süreçleri gözden geçirilmeli";
else if (maxDept === "paketleme")
  decision = "Paketleme standartları iyileştirilmeli";
